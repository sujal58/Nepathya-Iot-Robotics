...
function GetInTouch() {
  ...
  return (
    <div className="min-h-[82vh] space-y-10 relative justify-center items-center max-w-screen ">
      {/* bg-gradient-to-r from-teal-500 to-text-secondary */}
      <ParticleBackground color="black" />
      <div className="z-30 text-white text-center">
        <h2 className="font-playfair font-semibold text-text-secondary text-center text-3xl leading-10">
          Get in Touch with us !!
        </h2>
        <p className="text-xl text-black font-montserrat">
          <i>
      ...
      <div className="flex justify-around w-full items-center h-full">
        <div className="relative w-1/2 flex z-10 h-full  items-center justify-center text-white">
