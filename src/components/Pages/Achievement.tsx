...
function Achievement() {
  ...
  return (
    <div className=" relative z-30 min-h-[82vh] bg-white">
      <div className="flex flex-col gap-10 pt-5 px-12 py-10 relative z-30 min-h-[82vh] justify-around ">
        <div className="title text-text-primary font-bold font-playfair xs:text-xl sm:text-2xl md:text-4xl text-center">
          OUR ACHIEVEMENT
        </div>
